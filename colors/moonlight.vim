...
let s:variable_grey = s:colors.variable_grey
...
call s:h("Constant", { "fg": s:variable_grey }) " any constant
call s:h("String", { "fg": s:green }) " a string constant: "this is a string"
call s:h("Character", { "fg": s:light_red }) " a character constant: 'c', '\n'
...
call s:h("Label", { "fg": s:yellow }) " case, default, etc.
...
call s:h("Type", { "fg": s:light_red }) " int, long, char, etc.
...
call s:h("StatusLine", { "fg": s:white, "bg": s:statusline }) " status line of current window
call s:h("StatusLineNC", { "fg": s:comment_grey }) " status lines of not-current windows Note: if this is equal to "StatusLine" Vim will use "^^^" in the status line of the current window.
call s:h("TabLine", { "fg": s:comment_grey }) " tab pages line, not active tab page label
call s:h("TabLineFill", {"bg": s:statusline }) " tab pages line, where there are no labels
...
call s:h("sassVariable", { "fg": s:orange })
" https://github.com/cakebaker/scss-syntax.vim
call s:h("scssExtend", { "fg": s:purple })
call s:h("scssExtendedSelector", { "fg": s:orange })
