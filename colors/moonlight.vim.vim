...
let g:colors_name="moonlight.vim"


let Italic = ""
if exists('g:moonlight.vim_italic')
  let Italic = "italic"
endif
let g:moonlight.vim_italic = get(g:, 'moonlight.vim_italic', 0)

let Bold = ""
if exists('g:moonlight.vim_bold')
  let Bold = "bold"
endif

let g:moonlight.vim_bold = get(g:, 'moonlight.vim_bold', 0)
...
hi cssTagName guifg=#ff757f ctermfg=210 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi cssFunction guifg=#50c4fa ctermfg=81 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi cssURL guifg=#f3c1ff ctermfg=219 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi cssClassName guifg=#ffc777 ctermfg=222 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi cssClassNameDot guifg=#b4f9f8 ctermfg=159 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi cssProp guifg=#82aaff ctermfg=111 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi cssAttr guifg=#82aaff ctermfg=111 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi atKeyword guifg=#b4f9f8 ctermfg=159 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi stylusId guifg=#c099ff ctermfg=141 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
