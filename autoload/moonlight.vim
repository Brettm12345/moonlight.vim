...
let s:colors = {
      ...
      \ "gutter_fg_grey": get(s:overrides, "gutter_fg_grey", { "gui": "#5b6395", "cterm": "238", "cterm16": "15" }),
      \ "gutter_fg_active_grey": get(s:overrides, "gutter_fg_active_grey", { "gui": "#9da5d7", "cterm": "238", "cterm16": "15" }),
